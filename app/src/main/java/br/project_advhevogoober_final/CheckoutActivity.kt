...
import br.project_advhevogoober_final.Util.Json
...
class CheckoutActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //var offer: HashMap<String, String> = getIntent().getExtras()?.getSerializable("offer")

        val intent = intent
        val offer = intent.getSerializableExtra("offer") as Offer
        //val newhashMap = hashMapObject["key"] as HashMap<String, Any>
        //detailTitle.text = offer.get("price").toString()
...
//    }
    ...
    private fun displayGarment(garment:JSONObject) {
        offerPrice.setText(garment.getString("title"))
